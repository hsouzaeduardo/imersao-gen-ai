...
São seis labs, e cada um existe porque o anterior falhou de um jeito específico.
...
Os dois percorrem os mesmos seis capítulos, com a mesma base de dados e o mesmo
